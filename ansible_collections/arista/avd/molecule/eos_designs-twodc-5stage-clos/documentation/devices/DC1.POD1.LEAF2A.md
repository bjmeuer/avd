...
| --------- | ----------- | ---- | ------------- |
| Ethernet3 | L2_DC1-POD1-L2LEAF2A_Ethernet1 | active | 3 |
| Ethernet4 | L2_DC1-POD1-L2LEAF2B_Ethernet1 | active | 3 |
| Ethernet5 | MLAG_DC1-POD1-LEAF2B_Ethernet5 | active | 5 |
| Ethernet6 | MLAG_DC1-POD1-LEAF2B_Ethernet6 | active | 5 |
| Ethernet16 | SERVER_server-1_Eth1 | active | 16 |
| Ethernet17 | Set using structured_config on server adapter | active | 17 |
| Ethernet18 | SERVER_server-1_Eth5 | active | 18 |
| Ethernet19 | SERVER_server-1_Eth7 | active | 19 |
...
| Port-Channel5 | MLAG_DC1-POD1-LEAF2B_Port-Channel5 | default | - | False | - | - | - | - |
